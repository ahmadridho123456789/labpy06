...
print(d("oke"))
```
### __dan berikut output nya__


![gambar1](image/ss2.png)
...
# __berikut contoh program nya__

![gambar2](image/ss3.png)
...
```py
        ...
        break
```
## __dan berikut output program nya__
![gambar](image/ss4.png)

## __berikut flowchart nya__
